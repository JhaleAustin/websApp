        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            ...
            {materials.map((material) => (
             <div key={material.plantType} className="border-t border-gray-200 pt-4">
             <dt className="font-medium text-gray-900">{material.height}</dt>
             <dd className="mt-2 text-sm text-gray-500">{material.plantType}</dd>
           </div>
          ))}
